...
<div class="p-2">
	<h3 style="text-align: center; font-size: xx-large;color: white;">REGISTERED STUDENT'S INFORMATION</h3>
					<div class="accordion " id="accordionExample">
						...
						<div class="card bg-secondary text-white">
						  <div class="card-header" id="headingOne">
						  	<h5 style="text-align: center;"><b>DIPLOMA</b></h5><br>
							<h2 class="mb-1">
							<button class="btn btn-outline-dark" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="width: 800px;"><b>Diploma in English - DI_ENG</b></button>
							</h2>
						  </div>
                ...
                $Result = mysqli_query($Connection,"SELECT * FROM payment WHERE program_id='DI_ENG'");
						...
						<div class="card">
							<div class="card bg-secondary text-white">
							  <div class="card-header" id="headingTwo">
								<h2 class="mb-1">
								  <button class="btn btn-outline-dark" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="width: 800px;"><b>Diploma in Hospitality, Tourism and Event Management - DI_HTE</b></button>
								</h2>
								</div>
...
<?php
                ...
                $Result = mysqli_query($Connection,"SELECT * FROM payment WHERE program_id='DI_HTE'");
